...
export function getDateByType(date: Date, type: TimePickerType) {
  switch (type) {
    case "minutes":
      return pipe(date.getMinutes(), String, getValidMinuteOrSecond);
    case "seconds":
      return pipe(date.getSeconds(), String, getValidMinuteOrSecond);
    case "hours":
      return pipe(date.getHours(), String, getValidHour);
    case "12hours":
      return pipe(date.getHours(), display12HourValue, String, getValid12Hour);
    default:
      return "00";
  }
}
